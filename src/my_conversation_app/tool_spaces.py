...
from my_conversation_app.config import USER_PERSONALITIES_DIRNAME, config
...
from my_conversation_app.profile_store import DEFAULT_PROFILE_NAME, list_profile_names
