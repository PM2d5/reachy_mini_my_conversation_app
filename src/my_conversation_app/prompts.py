...
CAMERA_TOOL_RULE = (
    ...
    "what am I wearing or holding, how do I look, how many people are here, who is in "
    "front of you or who the user is (我是谁/你认识我吗/你看到了谁), 看看/看到/你看得见吗 — "
    "your FIRST action is to call `camera`. Do not answer from imagination, "
...
EMOTION_TOOL_RULE = (
    ...
    "gesture — 开心/伤心/难过/生气/害怕/惊讶/无聊/困, 做个表情/show me "
    ...
    "无聊→bored, 困→sleepy, 同意→yes, 不同意→no; no clear match → random). Only then "
