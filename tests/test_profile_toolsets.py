...
import my_conversation_app.profile_store as profile_store_mod
...
def test_enabling_tools_does_not_overwrite_a_concurrent_profile_save(
    ...
    monkeypatch.setattr("my_conversation_app.profile_toolsets.read_profile_tool_names", paused_read)
